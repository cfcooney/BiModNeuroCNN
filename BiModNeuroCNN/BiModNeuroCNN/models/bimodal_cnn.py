...
class SubNet(BaseModel):
    ...
    def create_network(self):
        ...
        if self.split_first_layer:
            ...
            n_filters_op = self.n_filters_spat * (self.input_time_length - 4) # semi-hardcoded at the moment
        else:
            model.add_module("conv_time", nn.Conv2d(self.in_chans, self.n_filters_time,
                                                    (self.filter_time_length, 1), stride=1,
                                                    bias=not self.batch_norm, ), )
            n_filters_conv = self.n_filters_time
            n_filters_op = self.n_filters_time * (self.input_time_length - 4) # semi-hardcoded at the moment
        ...
        if self.structure == "deep":
            ...
            n_filters_op = self.n_filters_2 * (self.input_time_length - 23) # semi-hardcoded at the moment
...
class BiModalNet(nn.Module):
    ...
    def __init__(self, n_classes, in_chans_1, input_time_1, SubNet_1_params, in_chans_2, input_time_2,
        ...
        self.subnet_1 = SubNet(in_chans=self.in_chans_1, n_classes=self.n_classes, input_time_length=self.input_time_1,
                                ...
                                pool_time_length=self.SN1_pool_time_length, pool_time_stride=self.SN1_pool_time_stride, final_conv_length='auto',
        ...
        self.subnet_2 = SubNet(in_chans=self.in_chans_2, n_classes=self.n_classes, input_time_length=self.input_time_2,
                                ...
                                pool_time_length=self.SN2_pool_time_length, pool_time_stride=self.SN2_pool_time_stride, final_conv_length='auto',
